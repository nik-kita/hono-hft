...
var Hi = { exports: {} }, el = {}, Wi = { exports: {} }, L = {}; /**
 * @license React
...
L.cloneElement = function (e, n, t) {
  ...
  if (n != null) {
    ...
    for (s in n) {
      Gi.call(n, s) && !Zi.hasOwnProperty(s) &&
  ...
  function r(_) {
    ...
    if (z !== N) {
      ...
      e: for (var H = 0, X = _.length, bt = X >>> 1; H < bt;) {
        var vn = 2 * (H + 1) - 1, gl = _[vn], hn = vn + 1, er = _[hn];
        if (0 > l(gl, z)) {
          hn < X && 0 > l(er, gl)
            ? (_[H] = er, _[hn] = z, H = hn)
            : (_[H] = gl, _[vn] = z, H = vn);
        } else if (hn < X && 0 > l(er, z)) _[H] = er, _[hn] = z, H = hn;
        else break e;
      }
    }
    return N;
...
var He = !(typeof window > "u" || typeof window.document > "u" ||
...
function dt(e, n) {
  e.blockedOn === n &&
    (e.blockedOn = null,
      au ||
      (au = !0, he.unstable_scheduleCallback(he.unstable_NormalPriority, ef)));
}
function Ft(e) {
  function n(l) {
    return dt(l, e);
...
var Xn = Ye.ReactCurrentBatchConfig, Ir = !0;
function nf(e, n, t, r) {
...
function ri() {
  Ct && (Ct.detachEvent("onpropertychange", As), jt = Ct = null);
}
function As(e) {
...
function Mf(e, n, t) {
  e === "focusin"
    ? (ri(), Ct = n, jt = t, Ct.attachEvent("onpropertychange", As))
    : e === "focusout" && ri();
}
function Df(e) {
...
function Uf(e) {
  ...
  if (
    n !== t && t && t.ownerDocument && Vs(t.ownerDocument.documentElement, t)
  ) {
    if (r !== null && ro(t)) {
      if (
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null;) {
          ...
          if (
            d.tag === 5 && h !== null &&
            (d = h,
              f !== null && (h = Mt(a, f), h != null && S.push(At(a, h, d)))), F
          ) break;
          a = a.return;
        }
        0 < S.length &&
    ...
    if (!(n & 7)) {
      e: {
        if (
          p = e === "mouseover" || e === "pointerover",
            ...
            p && t !== lu && (w = t.relatedTarget || t.fromElement) &&
            (wn(w) || w[We])
        ) break e;
        if (
          (g || p) &&
      ...
      e: {
        if (
          ...
          if ($s) E = Ff;
            ...
            (p.type === "checkbox" || p.type === "radio") && (E = If);}
        if (E && (E = E(e, c))) {
          Us(m, E, t, v);
          break e;
        }
        C && C(e, p, c),
          e === "focusout" && (C = p._wrapperState) && C.controlled &&
          p.type === "number" && bl(p, "number", p.value);
      }
      ...
      (Is && t.locale !== "ko" &&
        (In || P !== "onCompositionStart"
          ...
          : (be = v, bu = "value" in be ? be.value : be.textContent, In = !0)),
        C = jr(c, P),
        0 < C.length &&
...
function jr(e, n) {
  for (var t = n + "Capture", r = []; e !== null;) {
    ...
    (l = u,
      ...
      u = Mt(e, n),
      u != null && r.push(At(e, u, l))), e = e.return;
  }
  return r;
}
function Rn(e) {
  ...
  for (var u = n._reactName, o = []; t !== null && t !== r;) {
    ...
    (i = c,
      l
        ...
        : l || (s = Mt(t, u), s != null && o.push(At(t, s, i)))), t = t.return;
  }
...
var hu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Kf = typeof queueMicrotask == "function"
    ? queueMicrotask
    : typeof fi < "u"
    ? function (e) {
...
var Hr = pn(null), Wr = null, Bn = null, io = null;
function so() {
  io = Bn = Wr = null;
}
function ao(e) {
  ...
  for (; e !== null;) {
    ...
    if (
      (e.childLanes & n) !== n
        ...
        : r !== null && (r.childLanes & n) !== n && (r.childLanes |= n), e === t
    ) break;
    e = e.return;
  }
}
...
function ta(e, n, t, r) {
  var l = n.interleaved;
  return l === null ? (t.next = t, co(n)) : (t.next = l.next, l.next = t),
    n.interleaved = t,
    Qe(e, r);
}
function Qe(e, n) {
...
function un(e, n, t) {
  ...
  if (r = r.shared, R & 2) {
    var l = r.pending;
    return l === null ? n.next = n : (n.next = l.next, l.next = n),
      r.pending = n,
      Qe(e, t);
  }
...
function oa(e) {
  ...
  function s(f, a, d, h) {
    var E = d.type;
    return E === Dn ? v(f, a, d.props.children, h, d.key) : a !== null &&
        (a.elementType === E ||
          typeof E == "object" && E !== null && E.$$typeof === Ge &&
            ki(E) === a.type)
  ...
  function F(f, a, d, h) {
    if (
      typeof d == "object" && d !== null && d.type === Dn && d.key === null &&
...
var et = oa(!0), ia = oa(!1), qt = {}, je = pn(qt), Bt = pn(qt), Ht = pn(qt);
function kn(e) {
...
function sa(e) {
  kn(Ht.current);
  var n = kn(je.current), t = nu(n, e.type);
  n !== t && (M(Bt, e), M(je, t));
}
function mo(e) {
...
function xi(e) {
  do {
    ...
    if (
      (n = e.tag === 13) &&
      (n = e.memoizedState, n = n !== null ? n.dehydrated !== null : !0), n
    ) return e;
    e = e.return;
  } while (e !== null);
  return null;
...
function zi(e, n, t, r, l) {
  if (e === null) {
    var u = t.type;
    return typeof u == "function" && !zo(u) && u.defaultProps === void 0 &&
...
function Ra(e, n, t) {
  ...
  } else {u !== null ? (r = u.baseLanes | t, n.memoizedState = null) : r = t,
      M(Wn, pe),
      pe |= r;}
...
function Li(e, n, t, r, l) {
  ...
  if (Gn(n, l), n.stateNode === null) {
    Pr(e, n), ua(n, t, r), _u(n, t, r, l), r = !0;
  } else if (e === null) {
      ...
      ? (typeof g == "function" && (Eu(n, t, g, r), w = n.memoizedState),
        (c = Ze || wi(n, t, c, r, p, w, s) || !1)
          ...
          : (typeof o.componentDidUpdate != "function" ||
            i === e.memoizedProps && p === e.memoizedState || (n.flags |= 4),
            typeof o.getSnapshotBeforeUpdate != "function" ||
            i === e.memoizedProps && p === e.memoizedState || (n.flags |= 1024),
            n.memoizedProps = r,
            n.memoizedState = w),
        o.props = r,
        o.state = w,
...
function Pu(e, n, t, r, l, u) {
  ...
  var i = o && typeof t.getDerivedStateFromError != "function"
    ? null
    : r.render();
  return n.flags |= 1,
    e !== null && o
...
function Ma(e) {
  ...
  n.pendingContext
    ...
    : n.context && pi(e, n.context, !1), po(e, n.containerInfo);
}
...
function ko(e, n) {
  return n = fl({ mode: "visible", children: n }, e.mode, 0, null),
    n.return = e,
    e.child = n;
}
function mr(e, n, t, r) {
    ...
    for (c in r) {
      ...
      if (
        ...
        if (c === "style") {
          if (i) {
            for (o in i) {
              !i.hasOwnProperty(o) || s && s.hasOwnProperty(o) ||
                (t || (t = {}), t[o] = "");
            }
            for (o in s) {
            ...
            ? typeof s != "string" && typeof s != "number" ||
              (u = u || []).push(c, "" + s)
            : c !== "suppressContentEditableWarning" &&
              c !== "suppressHydrationWarning" && (Rt.hasOwnProperty(c)
  ...
  switch (uo(n), n.tag) {
    ...
    case 3:
      return r = n.stateNode,
        ...
        (dr(n)
          ? n.flags |= 4
          : e === null || e.memoizedState.isDehydrated && !(n.flags & 256) ||
                ...
                ? typeof i == "string"
                  ? r.textContent !== i &&
                    (u.suppressHydrationWarning !== !0 &&
                      ...
                      l = ["children", i])
                  : typeof i == "number" && r.textContent !== "" + i &&
                    (u.suppressHydrationWarning !== !0 &&
                      fr(r.textContent, i, e),
                      l = ["children", "" + i])
                : Rt.hasOwnProperty(o) && i != null && o === "onScroll" &&
                  D("scroll", r);
            }
          }
          switch (t) {
    ...
    case 6:
      if (e && n.stateNode != null) Ua(e, n, e.memoizedProps, r);
        ...
        if (t = kn(Ht.current), kn(je.current), dr(n)) {
          ...
          u && (n.flags |= 4);
        } else {r = (t.nodeType === 9 ? t : t.ownerDocument).createTextNode(r),
            r[Ie] = n,
            n.stateNode = r;}
      }
      return ne(n), null;
    ...
    case 19:
      ...
      if (r = (n.flags & 128) !== 0, o = u.rendering, o === null) {
        ...
        if (!r) {
          ...
          } else {2 * W() - u.renderingStartTime > rt && t !== 1073741824 &&
              (n.flags |= 128, r = !0, vt(u, !1), n.lanes = 4194304);}
        }
        u.isBackwards
...
function dd(e, n) {
  ...
  for (
    mu = { focusedElem: e, selectionRange: t }, Ir = !1, k = n;
    k !== null;
  ) {
...
function Va(e, n, t) {
  ...
  switch (t.tag) {
    ...
    case 15:
      if (
        !te && (r = t.updateQueue, r !== null && (r = r.lastEffect, r !== null))
      ) {
        l = r = r.next;
        do {
          var u = l, o = u.destroy;
...
function Ba(e, n) {
  ...
  switch (e.tag) {
    ...
    case 5:
      if (
        Pe(n, e), Me(e), r & 512 && t !== null && Hn(t, t.return), e.flags & 32
      ) {
        var l = e.stateNode;
        try {
          Ot(l, "");
          ...
          try {
            ...
            switch (i) {
              ...
              case "select":
                ...
                g != null
                  ? Qn(l, !!u.multiple, g, !1)
                  : p !== !!u.multiple && (u.defaultValue != null
    ...
    case 13:
      Pe(n, e),
        ...
        (u = l.memoizedState !== null,
          ...
          !u || l.alternate !== null && l.alternate.memoizedState !== null ||
          (Co = W())),
        r & 4 && Di(e);
      break;
    case 22:
...
function gd(e, n, t, r) {
  ...
  if (
    Jc(e, u),
      e === Z && (Q = Z = null, q = 0),
      !(t.subtreeFlags & 2064) && !(t.flags & 2064) || hr ||
      (hr = !0,
        Ja(Mr, function () {
          return Zn(), null;
        })),
...
function Zn() {
  if (en !== null) {
    var e = Ns(Jr), n = Ee.transition, t = O;
    try {
...
function Od() {
  ...
  return Tt.useEffect(() => {
    fetch("/api/hello").then((t) => t.text()).then((t) => {
      console.log(t), n(t);
    });
  }, []),
    On.jsxs("div", {
      children: [
        On.jsx("h1", { children: "Hello" }),
        On.jsx("h2", { children: e }),
        On.jsx("pre", { children: JSON.stringify(Rd) }),
      ],
    });
}
Ql.createRoot(document.getElementById("root")).render(
  On.jsx(wc.StrictMode, { children: On.jsx(Od, {}) }),
);
